...
public class EntityRelationshipFigure extends CompositeFigure {
    private static final int BORDER = 3;
    private Rectangle fDisplayBox;
    private java.util.List fPreTasks;
    private java.util.List fPostTasks;

    /*
     * Serialization support.
     */
    private static final long serialVersionUID = -7877776240236946511L;
    private int ERFigureSerializedDataVersion = 1;

    public EntityRelationshipFigure() {
        initialize();
    }
