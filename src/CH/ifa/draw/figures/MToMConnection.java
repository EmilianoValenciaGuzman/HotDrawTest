...
public class MToMConnection extends PolyLineFigure implements ConnectionFigure{
     ...
     */
    public MToMConnection() {
        super(4);
        setStartDecoration(new MTip());
        setEndDecoration(new MTip());
    }
